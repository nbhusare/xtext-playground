...
public class UiDslSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        UiModelFile uiModelFile = (UiModelFile)theEObject;
        T result = caseUiModelFile(uiModelFile);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Ui Model File</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Ui Model File</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseUiModelFile(UiModelFile object)
  {
    return null;
  }
